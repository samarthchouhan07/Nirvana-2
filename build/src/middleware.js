...
export default function middleware(req) {
    return __awaiter(this, void 0, void 0, function () {
        var token, pathname, urlOrigin;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getToken({ req: req })];
                case 1:
                    token = _a.sent();
                    pathname = req.nextUrl.pathname;
                    urlOrigin = "http://localhost:3000/";
                    if (pathname.includes('/admin') && !(token === null || token === void 0 ? void 0 : token.isAdmin)) {
                        return [2 /*return*/, NextResponse.redirect(urlOrigin)];
                    }
                    if (!pathname.includes("/login") && !pathname.includes('/signup') && !token) {
                        return [2 /*return*/, NextResponse.redirect(urlOrigin + 'login')];
                    }
                    if ((pathname.includes('/login') || pathname.includes('/signup')) && token) {
                        return [2 /*return*/, NextResponse.redirect(urlOrigin)];
                    }
