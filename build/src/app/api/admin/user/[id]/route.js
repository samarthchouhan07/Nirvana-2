...
export function PUT(req, ctx) {
    return __awaiter(this, void 0, void 0, function () {
        var id, body, updatedUser, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    deletedUser = _a.sent();
                    if (deletedUser) {
                        return [2 /*return*/, NextResponse.json({ message: "user has been successfully deleted" }, { status: 200 })];
                    }
                    else {
                        return [2 /*return*/, NextResponse.json({ message: "user with the id of ".concat(id, " doesnt exist ") })];
                    }
                    return [3 /*break*/, 4];
                case 3:
                    error_3 = _a.sent();
