...
const Dashboard = () => {
    const [usersQuery, listingsQuery, reservationsQuery, revenueQuery, mostReservedQuery,] = useWidgetHook();
  ...
  <div className="ml-2 w-full h-full flex flex-col col-span-7 overflow-visible ">
    <div className="grid grid-cols-4 gap-8">
      {widgetData === null || widgetData === void 0 ? void 0 : widgetData.map(({ page, data, icon }) => (<Widget key={page} page={page} data={data} icon={icon}/>))}
    </div>
