    ...
    return (<AdminLayout>
      <div className="p-6 lg:p-12 min-h-screen w-full bg-gray-50">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {(data === null || data === void 0 ? void 0 : data.length) > 0 ? (data === null || data === void 0 ? void 0 : data.map((reservation) => (<Card key={reservation.id} reservation={reservation} mutate={mutate}/>))) : (<div className="col-span-full text-center">
